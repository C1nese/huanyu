...
<tr>
<td height="49"><img src="/<?php echo (APP_NAME); ?>/Common/images/Step-step3-<?php echo ($lang); ?>.gif" /></td>
<td></td>
</tr>
<tr>
<td valign="top">
...
<div id="js-monitor" style="display:none;text-align:left;position:absolute;top:45%;left:35%;width:300px;z-index:1000;border:1px solid #000;">
    ...
    <div style="background:#fff;padding-bottom:20px;">
        <img id="js-monitor-loading" src='/<?php echo (APP_NAME); ?>/Common/images/loading.gif' /><br /><br />
    ...
    <img id="js-monitor-close" src='/<?php echo (APP_NAME); ?>/Common/images/close.gif' style="position:absolute;top:10px;right:10px;cursor:pointer;" />
</div>
