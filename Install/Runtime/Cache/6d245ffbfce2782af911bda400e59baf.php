...
<link href="/<?php echo (APP_NAME); ?>/Common/css/install.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="/Public/jquery-1.4.2.min.js"></script>
<script type="text/javascript" src="/<?php echo (APP_NAME); ?>/Common/js/transport.js"></script>
<script type="text/javascript" src="/<?php echo (APP_NAME); ?>/Common/js/common.js"></script>
<script type="text/javascript" src="/<?php echo (APP_NAME); ?>/Common/js/draggable.js"></script>
<script type="text/javascript" src="/<?php echo (APP_NAME); ?>/Common/js/setting.js"></script>
...
<div id="logos">
	<div id="lang-menu">
		...
		<?php echo ($langs['select_installer_lang']); ?><img src="/<?php echo (APP_NAME); ?>/Common/images/cn.gif" alt="<?php echo ($langs['simplified_chinese']); ?>" />
		<input type="radio" name="js-lang" id="js-zh_cn" class="p" />
		<label for="js-zh_cn"><?php echo ($langs['simplified_chinese']); ?></label>&nbsp;&nbsp;&nbsp;&nbsp;
	

		<img src="/<?php echo (APP_NAME); ?>/Common/images/tw.gif" alt="<?php echo ($langs['traditional_chinese']); ?>" />
		<input type="radio" name="js-lang" id="js-zh_tw" class="p" />
		<label for="js-zh_tw"><?php echo ($langs['traditional_chinese']); ?></label>&nbsp;&nbsp;&nbsp;&nbsp;

		<img src="/<?php echo (APP_NAME); ?>/Common/images/us.gif" alt="<?php echo ($langs['americanese']); ?>" />
...
<img id="js-monitor-loading" src='/<?php echo (APP_NAME); ?>/Common/images/loading.gif' style="margin:30px 0 50px 0;"/>
</div>
...
<?php if(isset($app_list)): ?>Ajax.call('/Install/index.php?s=/Install/<?php echo ($step); ?>/lang/<?php echo ($lang); ?>/app_list/<?php echo ($app_list); ?>','', callback_api, 'GET', 'TEXT','FLASE');

<?php else: ?>

Ajax.call('/Install/index.php?s=/Install/<?php echo ($step); ?>/lang/<?php echo ($lang); ?>','', callback_api, 'GET', 'TEXT','FLASE');<?php endif; ?>
...
function callback_api(result)
{
  if(result)
  {
	...
	<?php case "check": ?>jQuery('.list tr').bind('mouseover',function()
		...
		document.getElementById('formcheck').action='/Install/index.php?s=/Install/index/lang/' + getAddressLang() + '/step/setup/app/' + getAppList();<?php break;?>
