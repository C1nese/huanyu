...
$_LANG['copyright'] = '&copy; 2012-'.date('Y').' <a href="http://9885.net" target="_blank">Linyi Xinshang Network Technology Co,.Ltd. </a> <br> All right reserved.';

/* Welcome page */
$_LANG['welcome_title'] = 'Welcome to choose new commercial software!';
...
$_LANG['version_msg'] = 'Your currently installed version is the latest version';
$_LANG['select_setup_app'] = 'Select the application you want to install';
$_LANG['App_Admin'] = 'Application Center';
$_LANG['App_ShopAdmin'] = 'Mall';
$_LANG['App_Company_Admin'] = 'Company Site';
$_LANG['App_DmsAdmin_Admin'] = 'Dms';
...
$_LANG['admin_account'] = 'Super administrator account';
$_LANG['admin_name'] = 'Login accounts:';
...
$_LANG['dbname_empty_error'] = 'Database name can not be empty.';
$_LANG['dbuser_empty_error'] = 'Database user name can not be empty.';
$_LANG['dbport_empty_error'] = 'Database port number can not be empty.';
$_LANG['cannt_create_database'] = 'Can\'t create database.';
$_LANG['account_empty_error'] = 'Please enter login account.';
$_LANG['password_empty_error'] = 'Please enter login password.';
$_LANG['passwords_not_eq'] = 'The two login passwords you entered did not match.';
...
$_LANG['install_done_title'] = 'system install program, install successfully.';
$_LANG['install_error_title'] = 'system install program, install failed.';
$_LANG['done'] = 'Congratulation，system has installed successfully.<br />Based on security consideration, please delete install directory at once.';
$_LANG['go_to_view_my_site'] = 'Homepage';
$_LANG['go_to_view_control_panel'] = 'Control panel';
$_LANG['open_config_file_failed'] = 'Can\'t write, please check whether the file can be wrote.';
$_LANG['write_config_file_failed'] = 'Error, the file can\'t be wrote.';
$_LANG['not_select_app'] = 'Not select the application you want to install.';
...
$_LANG['js_languages']['password_short'] = 'Should not be less than 6!';
$_LANG['js_languages']['password_not_eq'] = 'The two passwords did not match.';

/* timezone */
$_LANG['timezone']['UTC']	= 'UTC';
$_LANG['timezone']['PRC']	= 'PRC';
$_LANG['timezone']['Asia/Shanghai']	= 'Asia/Shanghai';
$_LANG['timezone']['Asia/Taipei']	= 'Asia/Taipei';
$_LANG['timezone']['Asia/Chongqing']	= 'Asia/Chongqing';
$_LANG['timezone']['Asia/Chungking']	= 'Asia/Chungking';
$_LANG['timezone']['Asia/Harbin']	= 'Asia/Harbin';
$_LANG['timezone']['Asia/Urumqi']	= 'Asia/Urumqi';
$_LANG['timezone']['Asia/Hong_Kong']	= 'Asia/Hong_Kong';
$_LANG['timezone']['Hongkong']	= 'Hongkong';
$_LANG['timezone']['Asia/Macau']	= 'Asia/Macau';
$_LANG['timezone']['Asia/Macao']	= 'Asia/Macao';
$_LANG['timezone']['Asia/Singapore']	= 'Asia/Singapore';
$_LANG['timezone']['Singapore']	= 'Singapore';
$_LANG['timezone']['Asia/Seoul']	= 'Asia/Seoul';
$_LANG['timezone']['Asia/Tokyo']	= 'Asia/Tokyo';
$_LANG['timezone']['Europe/Berlin']	= 'Europe/Berlin';
$_LANG['timezone']['Europe/Dublin']	= 'Europe/Dublin';
$_LANG['timezone']['Europe/Paris']	= 'Europe/Paris';
