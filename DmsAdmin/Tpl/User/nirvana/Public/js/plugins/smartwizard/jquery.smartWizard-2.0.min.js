    ...
    a.fn.smartWizard = function(m) {
        ...
        return this.each(function() {
            function C() {
                ...
                c.errorSteps && 0 < c.errorSteps.length && a.each(c.errorSteps,
                    function(a, b) {
                        y(b, !0)
                    });
                p.append(e);
            ...
            function w(e) {
                ...
                if ("slide" == c.transitionEffect) a(a(g, b).attr("href"), b).slideUp("fast",
                    function(c) {
                        a(a(d, b).attr("href"), b).slideDown("fast");
                        h = e;
                        u(g, d)
                    });
                else if ("fade" == c.transitionEffect) a(a(g, b).attr("href"), b).fadeOut("fast",
                    function(c) {
            ...
            function u(e, d) {
                ...
                a(d, b).attr("isDone", 1);
                c.cycleSteps || (0 >= h ? a(r).addClass("disabled") : a(r).removeClass("disabled"), f.length - 1 <= h ? a(q).addClass("disabled") : a(q).removeClass("disabled")); ! f.hasClass("disabled") || c.enableFinishButton ? a(s).removeClass("disabled") :
            ...
            if (m && "init" !== m && "object" !== typeof m) {
                ...
                if ("setError" === m) return v = Array.prototype.slice.call(x, 1),
