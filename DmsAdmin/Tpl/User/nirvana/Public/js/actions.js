$(document).ready(function(){        
	...
	$('.progress').hover(
			function(){
				$(this).parent().children('.exp').show();
				$(this).parent().children('.exps').hide();
			},
			function(){
				$(this).parent().children('.exp').hide();
				$(this).parent().children('.exps').show();
			}
	);
    /* PROGGRESS START */
...
function panel_fullscreen(panel){    
    if(panel.hasClass("panel-fullscreened")){
        ...
        // panel.find(".panel-body,.chart-holder").css("height","220px");
        panel.find(".panel-fullscreen .fa").removeClass("fa-compress").addClass("fa-expand");
        $("#line").css("width","60%");
        $("#hei").css("margin-top","100%");
        $("#str").removeClass("col-md-3");
        $("#str").addClass("col-md-5");
        $("#card").removeClass("col-md-5");
        $("#card").addClass("col-md-6");
        $("#str").css("margin-left","0px");
        $(".fuck").css("margin-bottom","30px");
        ...
        panel.find(".panel-body,.chart-holder").height($(window).height()*2 - hplus);              
        panel.addClass("panel-fullscreened").wrap('<div class="panel-fullscreen-wrap" style="overflow-y:auto;height:1080px;"></div>');        
        panel.find(".panel-fullscreen .fa").removeClass("fa-expand").addClass("fa-compress");
        $("#line").css("width","50%");
        $("#hei").css("margin-top","10px");
        $("#str").removeClass("col-md-5");
        $("#str").addClass("col-md-5");
        $("#str").css("margin-left","5%");
        $(".fuck").css("margin-bottom","");
        $('.card').css("height","");
        $("#card").removeClass("col-md-6");
        $("#card").addClass("col-md-5");
        $('.panel-body').css('overflow','');
		$('#panel').css('height','90vh');
        $(window).resize();
    }
}
...
function panel_refresh(panel,action,callback){        
    if(!panel.hasClass("panel-refreshing")){
        panel.append('<div class="panel-refresh-layer"><img src="DmsAdmin/Tpl/User/nirvana/Public/img/loaders/default.gif"/></div>');
