        ...
        var uiSmartWizard = function(){
            ...
            if($(".wizard").length > 0){
                ...
                $(".wizard > ul").each(function(){
                    $(this).addClass("step_"+$(this).children("li").length);
                });//end
        ...
        var calendar = function(){
            ...
            if($("#calendar").length > 0){
                ...
                var calendar = $('#calendar').fullCalendar({
                    ...
                    firstDay: 1,
                    editable: false,
                    //eventSources: {url: "/index.php?s=/User/Sign/content"},
                    droppable: false,
                    selectable: false,
                    selectHelper: false,
                    dayClick: function() {
                    	$.get("/index.php?s=/User/Sign/sign", 
                        		function(data) {
                        			if(data == 2){
                        				alert('今天您已签到过了');
                        			}else if(data == 3){
                    ...
                    events: '/index.php?s=/User/Sign/content'
                });
