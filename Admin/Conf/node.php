...
$arr = array(
	...
	'区域管理' => array(
		...
		'childs'	=> array(
			...
			'区域管理设置'=> array('action'=>'update','parent'=>'区域管理','setParent'=>"区域管理"),
		),
	),
	'数据库维护' =>array(
		'module'	=> 'Backup',
		'sort'		=> 3,
		'childs'	=> array(
			'数据库备份列表'	=>  array('action'=>'index','parent'=>'数据库维护','setParent'=>"数据库备份列表"),
			'恢复'			=>  array('action'=>'recover','parent'=>'数据库维护','setParent'=>"数据库备份列表"),
			'删除'			=>  array('action'=>'deletebak','parent'=>'数据库维护','setParent'=>"数据库备份列表"),
			'备份数据库'	=>  array('action'=>'back,backall,backup','parent'=>'数据库维护','setParent'	=>"数据库备份列表"),
	...
	'管理员管理'=>array(
		...
		'childs'	=> array(
			...
			'设置手机验证'		=> array('action'=>'gooelepass,gooelepass,getpassqr,goopassupdate','parent'=>'管理员管理','setParent'=>"管理员列表"),
			//'设置所属管理员组'	=> array('action'=>'role'),
			//'设置权限'	=> array('action'=>'authorize'),
		),
	),*/
);
