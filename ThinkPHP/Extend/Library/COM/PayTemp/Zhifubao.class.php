...
class Zhifubao implements PayInterface
{
	...
	{
		return '支付宝（alipay）最初作为淘宝网公司为了解决网络交易安全所设的一个功能，该功能为首先使用的“第三方担保交易模式”，由买家将货款打到支付宝账户，由支付宝向卖家通知发货，买家收到商品确认后指令支付宝将货款放于卖家，至此完成一笔网络交易。支付宝于2004年12月独立为浙江支付宝网络技术有限公司，是阿里巴巴集团的关联公司。支付宝公司于2010年12月宣布用户数突破5.5亿。2012年2月8日起，支付宝关闭信用卡充值服务，但可继续使用信用卡付款。2012年12月18日，支付宝暂停P2P资金流转合作，不再新签合同.';
	}
	...
	*/
	...
	{
		return array(
			array('name'=>'支付方式名称','config_name'=>'zhifubao_name','config_value'=> '支付宝支付'),
			array('name'=>'商户号','config_name'=>'zhifubao_key','config_value'=> ''),
		);
	}
	...
	//构造支付宝外部服务接口控制
	function zhifubao($parameter,$security_code,$sign_type = "MD5",$transport= "https") {
