...
class Huifu implements PayInterface
{
	...
	*/
	function __construct() 
	{
		...
		$accountid					= isset($data['huifu_accountid'])?$data['huifu_accountid']:'';
		$this->accountid			= $accountid?$accountid:'';

		$sign_type					= isset($data['huifu_sign_type'])?$data['huifu_sign_type']:'';
		$this->sign_type			= $sign_type?$sign_type:'';

		$com						= isset($data['huifu_com'])?$data['huifu_com']:'';
		$this->com					= $com?$com:'';

		$gateway					= isset($data['huifu_gateway'])?$data['huifu_gateway']:'';
		$this->gateway				= $gateway?$gateway:'';

		$private_key				= isset($data['huifu_private_key'])?$data['huifu_private_key']:'';
		$this->private_key			= $private_key?$private_key:'';

		$pubic_key					= isset($data['huifu_pubic_key'])?$data['huifu_pubic_key']:'';
