...
class PerfectMoney implements PayInterface
{
	...
	*/
	function __construct() 
	{
		...
		//读取数据库中的设置
		$Payee_Account				= isset($data['perfectmoney_receive_account'])?$data['perfectmoney_receive_account']:'';
		$this->Payee_Account		= $Payee_Account?$Payee_Account:'';
		$exchange_rate				= isset($data['perfectmoney_exchange_rate'])?$data['perfectmoney_exchange_rate']:'1';
	...
	public static function getConfigInfo()
	{
		return array(
			...
			array(
				'config_name'=>'perfectmoney_receive_account',
				'config_value'=> '',
				'name'=>'收款帐号',
				'type'=>'text',
				'style'=>'width:100px',
			...
			array(
				'config_name'=>'perfectmoney_exchange_rate',
				'config_value'=> '6.1865',
				'name'=>'美元汇率',
				'type'=>'text',
				'style'=>'width:100px',
