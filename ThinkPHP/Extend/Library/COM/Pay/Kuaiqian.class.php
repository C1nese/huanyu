...
class Kuaiqian implements PayInterface
{
	...
	*/
	function __construct() 
	{
		...
		//读取数据库中的设置
		$account					= isset($data['kuaiqian_id'])?$data['kuaiqian_id']:'';
		$key						= isset($data['kuaiqian_key'])?$data['kuaiqian_key']:'';
		$proxy						= isset($data['kuaiqian_proxy'])?$data['kuaiqian_proxy']:'';
