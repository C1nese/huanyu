...
class Ezybonds implements PayInterface
{
	...
	*/
	function __construct()
	{
		...
		//读取数据库中的设置
		$Model						= M();
		$merchant					= isset($data['ezybonds_merchant'])?$data['ezybonds_merchant']:'';
		$this->merchant				= $merchant?$merchant:'';

		$ezybonds_key				= isset($data['ezybonds_key'])?$data['ezybonds_key']:'';
