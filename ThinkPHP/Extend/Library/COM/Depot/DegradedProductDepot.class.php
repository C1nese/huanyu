...
*
*/
class DegradedProductDepot implements DepotInterface
{
	private $error_info		= '';  //错误信息
	private $in_table		= 'erp_degraded_product_depot_in';	//入库表名
	private $out_table		= 'erp_degraded_product_depot_out';	//出库表名
	private $depot_table	= 'erp_degraded_product_depot';		//库存表名
