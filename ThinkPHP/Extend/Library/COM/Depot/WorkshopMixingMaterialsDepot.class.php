...
*
*/
class WorkshopMixingMaterialsDepot implements DepotInterface
{
	private $error_info		= '';  //错误信息
	private $in_table		= 'erp_workshop_mixing_materials_depot_in';	//入库表名
	private $out_table		= 'erp_workshop_mixing_materials_depot_out';	//出库表名
	private $depot_table	= 'erp_workshop_mixing_materials_depot';		//库存表名
	...
	*/
	public function make_in_seria_number($seria_number_suffix_length=4)
	{
		...
		//流水号前缀
		$seria_number_prefix	= 'WMI'.date('ymd');
	...
	*/
	public function make_out_seria_number($seria_number_suffix_length=4)
	{
		...
		//流水号前缀
		$seria_number_prefix	= 'WMO'.date('ymd');
