...
class App {
    ...
    static public function init() {
        ...
        C('TEMPLATE_NAME',THEME_PATH.MODULE_NAME.(defined('GROUP_NAME')?C('TMPL_FILE_DEPR'):'/').((strpos(ACTION_NAME,':')===false) ? ACTION_NAME : substr(ACTION_NAME,0,strpos(ACTION_NAME,':'))).C('TMPL_TEMPLATE_SUFFIX'));
