...
return  array(
	...
	'SAFE_PWD'				=>'repass',//保存二级密码
	'USER_AUTH_NUM'			=>'useriral',//保存登陆用户的编号

    'APP_ARRAY'             =>array('user','admin'),//项目分组
	'DAY_OFFSET'            => 0,    //系统偏移时间
	'VERIFY_NUM'            =>3,     //验证错误多少次后出现验证码
	'VERIFY_TIME'           =>3600,  //验证码出现时间
    ...
    'TMPL_ACTION_SUCCESS'       =>  'Public:success', // 默认成功跳转对
    */
   ...
   // 'TMPL_TRACE_FILE'       =>THINK_PATH.'Tpl/page_trace.tpl',
    /* URL设置 */
